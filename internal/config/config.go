...
func ChainCatalog() []ChainOption {
	return []ChainOption{
		...
		{ChainID: 8453, Label: "Base", Endpoints: []rpc.Endpoint{{Name: "Base (PublicNode)", URL: "https://base-rpc.publicnode.com"}}},
		{ChainID: 42161, Label: "Arbitrum One", Endpoints: []rpc.Endpoint{{Name: "Arbitrum One (PublicNode)", URL: "https://arbitrum-one-rpc.publicnode.com"}}},
		{ChainID: 10, Label: "Optimism", Endpoints: []rpc.Endpoint{{Name: "Optimism (PublicNode)", URL: "https://optimism-rpc.publicnode.com"}}},
